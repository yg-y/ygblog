 ...
 * @Author : YangGuang
 * @Description:
 * @Date:Created in 14:11 2018/3/5
 * @Modified By:
 **/
public class ImageUtils {
     ...
     */
        ...
        public static void main(String[] args) {
            ...
            // 1-缩放图像：
            // 方法一：按比例缩放
            ImageUtils.scale("classpath:src/mian/webapp/static/img/img01.jpg", "classpath:src/mian/webapp/static/imgChange/abc_scale.jpg", 2, true);//测试OK
            // 方法二：按高度和宽度缩放
